...
<option value="0">Inactivo </option>
 ...
 <div class="col-sm-12 col-md-12">
  ...
  <form action="#" method="get" class="form-horizontal">
         ...
         <div class="col-md-3 col-md-offset-8" style="margin-top:10px; margin-left: 786px;"> <!--col-md-offset desplaza columnas a la derecha -->
                <div class="form-group">
...
{if (($ejecuta['estado'])==0) {
  ...
  <tr>
    ...
    <form   action="verDetalleCliente.blade.php" method="get" class="form-register" > 
     ...
     <form  style=" margin-left: 60px; margin-top:-22px;" action="TodosClientes.blade.php" method="get" class="form-register" > 
     <button  type="submit" title="Dar de Alta Cliente" class="glyphicon glyphicon-arrow-up btn-danger" id="btnalta1" name="btnalta1" style="background-color: transparent border:0" data-toggle="modal"  value=<?php echo $ejecuta['idCliente'] ?></button>
     </form>
    </td>
  </tr> 
