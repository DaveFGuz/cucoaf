...
?>
    ...
    <h2 class="col-lg-offset-0" ><strong>CLIENTE INCOBRABLES</strong></h2>
    </div>
    </div>
    </div>
    </div>  
...
<button type="button"  class="btn btn-primary color-boton" 
  onclick="envia()">Registrar Nuevo Cliente</button>
</div>
</div>
