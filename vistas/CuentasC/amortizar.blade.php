...
<button type="submit"  class="btn btn-primary" data-dismiss="modal" id="btnPre" style=" margin-left: 550px; margin-top:-53px;" name="btnPre" value=<?php echo $fila['idCli'] ?>>Atras</button>
</form>
