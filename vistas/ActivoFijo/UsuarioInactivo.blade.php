...
while($ejecuta=mysqli_fetch_array($ejecutar))
{
  ...
  <tr>
    ...
    <td>
     <button  disabled="true" type="submit" class="btn btn-danger" id="btnEditar" name="btnEditar" style="background-color: transparent border:0" data-toggle="modal"  value="<?php echo $ejecuta['idusu']?>" >Editar</button>
    
      
     <form  style=" margin-left: 70px; margin-top:-33px;" action="UsuarioMostrar.blade.php" method="get" class="form-register" > 
     <button  type="submit" class="btn btn-warning" id="btnalta1" name="btnalta1" style="background-color: transparent border:0" data-toggle="modal"  value=<?php echo $ejecuta['idusu'] ?>>Alta</button>
     </form>
    </td>
  </tr> 
