...
<body class="hold-transition skin-green-light sidebar-mini">
  <div class="wrapper">
    ...
    $aux9=$_SESSION['usuario'];
   $sentencia ="SELECT * FROM usuarios WHERE user=$aux9"; 
 ...
 <input type="hidden" class="form-control" id="hid" placeholder="Nombre" name="hid" value="<?php echo $_POST['btnEditar'];?>">
<div class="col-md-6">
<div class="input-group">

  <label for="nomb" id="noC" >Nombre:</label>
  <div class="input-group">
  <input type="text" class="form-control" id="nomb" placeholder="Nombre" name="nomb" value="<?php echo $fila['nombre'];?>">
...
<div class="input-group">
  ...
  <div class="input-group">
  <input type="text" class="form-control sombraCajas" id="dui" placeholder="00000000-0" name="dui" value="<?php echo $fila['dui'];?>">
...
<br>
 <div class="input-group">
  ...
  <label for="usu" id="oc" >Nombre de usuario:</label>
  <div class="input-group">
  <input type="text" class="form-control" id="usu" placeholder="Usuario" name="usu" value="<?php echo $fila['user'];?>">
...
<div class="input-group">
  ...
  <div class="input-group">
  <textarea type="text" class="form-control" id="dir" name="dir" style="width:300px;" value="<?php echo $fila['direccion'];?>"><?php echo $fila['direccion'];?></textarea> 
...
<div class="input-group">
  ...
  <div class="input-group">
  <input type="text" class="form-control" id="tel" placeholder="0000-0000" name="tel" value="<?php echo $fila['telefono'];?>">
...
<div class="input-group">
  ...
  <div class="input-group">
  <input type="text" class="form-control" id="contra" name="contra" value="<?php echo $fila['pass'];?>">
...
<button type="button" class="btn btn-primary" data-dismiss="modal" onclick="envia()">Cancelar</button>
</div>
</div>
