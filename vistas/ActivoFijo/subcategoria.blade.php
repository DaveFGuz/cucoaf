...
<body class="hold-transition skin-green-light sidebar-mini">
  <div class="wrapper">
    ...
    <h2 class="col-lg-offset-2" ><strong>GESTIÓN DE SUBCATEGORIA</strong></h2>
    </div>
    </div>
    </div>
    </div>  
...
<div class="form-group">
 ...
 <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-success" style="background-color: #2D943E">Guardar</button>
        <button type="button" class="btn btn-success" data-dismiss="modal" style="background-color: #A42727">Cancelar</button>
        </div>
      </div>
      </form>
      </div>
