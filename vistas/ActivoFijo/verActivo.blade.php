...
<button type="button"  class="btn btn-primary" data-dismiss="modal" onclick="envia()" style=" margin-left: 150px; margin-top:-53px; background-color: #A42727 " >Atras</button>
</div>
</div>
