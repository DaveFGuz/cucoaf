...
<body class="hold-transition skin-green-light sidebar-mini">
  <div class="wrapper">
    ...
    <h2 class="col-lg-offset-2" ><strong>GESTIÓN DE UBICACIONES</strong></h2>
    </div>
    </div>
    </div>
    </div>  
 ...
 <div class="col-md-2"></div>
  ...
  <div class="col-md-9 col-md-offset-5" style=" margin-left: 90px;">
  <div class="col-md-3">
<br>
 <div class="form-group">
<button type="button"  class="btn btn-primary" data-toggle="modal" data-target="#ModalRegistarProveedor" style="background-color: #4c9ea0" >Nueva Ubicación</button>
</div>
  </div>
...
<option selected value="1" >UBICACIONES ACTIVAS</option>
 
<option value="0">UBICACIONES INACTIVAS</option>
</select>
</div>
</div> 
 ...
 <div class="col-sm-12 col-md-12">
  ...
  <form action="#" method="get" class="form-horizontal">
         ...
         <div class="col-md-3 col-md-offset-9" style="margin-top:13px; margin-left: 615px;"> <!--col-md-offset desplaza columnas a la derecha -->
                <div class="form-group">
                    <!-- USE TWITTER TYPEAHEAD JSON WITH API TO SEARCH -->
                    <div class="input-group">
                     <input id="entradafilter" type="text" class="form-control"> 
                    <span class="input-group-btn">
                    <button type="submit" class="btn btn-primary" style="margin-right:-20px;"><i class="glyphicon glyphicon-search"></i>
...
<div class="input-group">
 ...
 <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" data-dismiss="modal" style="background-color: #A42727">Cancelar</button>
        </div>
      </div>
...
echo "<script type='text/javascript'>";
        echo "mostrarMensaje('Datos almacenados correctamente!!!', 'success',1900);";
        echo "</script>";
