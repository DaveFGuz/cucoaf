...
<body class="hold-transition skin-green-light sidebar-mini">
  <div class="wrapper">
    ...
    <h2 class="col-lg-offset-6" ><strong>INSTITUCION</strong></h2>>
    </div>
    </div>
    </div>
    </div>  
...
<button type="button"  class="btn btn-primary" data-dismiss="modal" onclick="limpia()">Limpiar</button>
<button type="button" style="background-color: #A42727"  class="btn btn-primary" data-dismiss="modal" onclick="envia()">Cancelar</button>
</div>
</div>
...
echo "<script type='text/javascript'>";
        echo "mostrarMensaje('DATOS ALMACENADOS EXITOSAMENTE', 'success',2500);";
        echo "</script>";
...
echo "<script type='text/javascript'>";
        echo "mostrarMensaje('DATOS MODIFICADOS', 'success',2500);";
        echo "</script>";
